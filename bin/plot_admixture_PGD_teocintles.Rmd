...
length(mylabs)
# get nice colors
mycols<-c("grey40","#917031", "#4d6cd0", "#8bbb39", "#c556c5", "#53d06a", "#895dc8", "#cc5658", "#d84492", "#69b974", "#d63c48", "#4dc0b1", "#d3542b", "#4b9cd3", "#d2a337", "#9289cf", "#b1b23a", "#9a5398", "#498331", "#cc4668", "#37835d", "#df89be", "#6e7721", "#9b496e", "#b9b06d", "#ac575b", "#65743a", "#e78b7a", "#db873d")
length(mycols)
# plot PGD raster
p<- ggplot() +
...
p_PGDmap<- ggplot()  +
    ...
    labs(x="", y= "") + theme(text = element_text(size = 15)) +
# add sampling points
geom_point(data=parvimeta, aes(x=LONGITUDE, 
                                   y=LATITUDE)) +
